        ...
        <Row>
            <Col :span="24">
                <Form :inline="true">
                    ...
                    <FormItem>
                      <DatePicker v-model="selectDate" type="date" :clearable='false' placeholder="日期" style="width: 200px"></DatePicker>
  ...
  methods: {
    ...
    commit () {
      if (this.orderForm.startTime === '' || this.orderForm.endTime === '') {
        alert('请输入起止时间段')
      } else if (this.orderForm.startTime <= this.orderForm.endTime) {
        alert('请输入正确的时间段')
      } else {
